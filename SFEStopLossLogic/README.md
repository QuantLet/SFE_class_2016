...
Description : 'Generates and plots the path of two stocks and marks the corresponding buying and
selling time points of a stop-loss hedging strategy'
...
Output : 'A plot of two simulated stocks with buy and sell times within the stop-loss hedging
strategy and two tables of the corresponding hedging costs.'
