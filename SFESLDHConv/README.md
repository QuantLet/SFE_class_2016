...
Description : 'Plots a log-log-graph of the performance of stop-loss and delta hedging for
decreasing observation frequancy'
...
SFSstoploss, SFEDeltahedgingLogic, SFEDeltahedgingdepend'
